// adapted from https://github.com/uiwjs/react-codemirror/blob/master/themes/xcode/src/index.ts
...
export function xcodeLightInit(options = null) {
...
export const defaultSettingsXcodeDark = {
  background: '#292A30',
  foreground: '#CECFD0',
  caret: '#fff',
  selection: '#727377',
...
export const xcodeDarkInit = (options = null) => {
